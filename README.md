...
## Yes, I know. There are a lot of repos.

Like... **a lot.**

I'm not trying to pretend I'm a traditional software engineer.
...
Depending on the project, you'll see some combination of:

`HTML` · `CSS` · `JavaScript` · `React` · `APIs` · `PWAs` · `Supabase` · `Netlify` · `GitHub`

plus a lot of:

`ChatGPT` · `Claude` · `Gemini` · prompt/context design · iterative debugging · QA · asking “why did that break?” repeatedly

I care less about collecting technologies and more about **getting an idea from concept → working prototype → something another human can actually use.**

---

## 👋 The non-GitHub version of me

I'm a **social media + content marketing strategist** who likes understanding why people care about things on the internet.
